        ...
        public void setDoors(int direction, Room oppositeRoom)
        {
            ...
            switch (direction)
            {
                ...
                case 2: // Süden
                    ...
                    oppositeDoorTile.TeleportPosition = new Vector2(oppositeDoorTile.getPos().X + doorTile.getTexture().Width / 2, oppositeDoorTile.getPos().Y + oppositeDoorTile.getTexture().Height + 60);
