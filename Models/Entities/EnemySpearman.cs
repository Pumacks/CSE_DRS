...
namespace GameStateManagementSample.Models.Entities
{
    public class EnemySpearman : Enemy
    {
        ...
        public EnemySpearman(int healthPoints, float movementSpeed, Vector2 playerPosition, Texture2D texture, SpriteFont spriteFont, List<Item> items, Weapon activeEnemyWeapon)
